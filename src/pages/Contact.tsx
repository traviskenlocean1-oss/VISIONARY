          ...
          >
            <div>
              <p className="text-sm md:text-base leading-loose" style={{ color: 'rgba(225,224,204,0.55)' }}>
                Tell us about your project. We'll get back to you fast — no forms that disappear
                into the void.
              </p>
            </div>
          ...
          >
            {status === 'sent' ? (
              <div
                ...
                style={{ background: '#101010', border: '1px solid rgba(59,130,246,0.2)' }}
              >
                <p className="font-bold text-xl mb-2" style={{ color: '#E1E0CC' }}>
                  Message received.
                </p>
                <p className="text-sm" style={{ color: 'rgba(225,224,204,0.45)' }}>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] tracking-[0.2em] uppercase" style={{ color: 'rgba(225,224,204,0.4)' }}>
                      Name
                    </label>
                    <input
                      name="name"
                      ...
                      className="w-full px-4 py-3 text-sm rounded-lg outline-none transition-colors duration-200"
                      style={{
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    name="project_type"
                    className="w-full px-4 py-3 text-sm rounded-lg outline-none transition-colors duration-200 appearance-none"
                    style={{
                      background: 'rgba(255,255,255,0.04)',
                      border: '1px solid rgba(255,255,255,0.08)',
                      color: '#E1E0CC',
                  ...
                  >
                    ...
                    <option value="New Website" style={{ background: '#111' }}>New Website</option>
                    <option value="Redesign" style={{ background: '#111' }}>Website Redesign</option>
                    <option value="Landing Page" style={{ background: '#111' }}>Landing Page</option>
                    <option value="Brand & Web" style={{ background: '#111' }}>Brand + Web</option>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 text-sm rounded-lg outline-none resize-none transition-colors duration-200"
                    style={{
                      background: 'rgba(255,255,255,0.04)',
                      border: '1px solid rgba(255,255,255,0.08)',
                      color: '#E1E0CC',
                ...
                <button
                  ...
                  style={{
                    background: status === 'sending' ? 'rgba(59,130,246,0.4)' : '#3b82f6',
                    color: '#fff',
                  }}
                >
