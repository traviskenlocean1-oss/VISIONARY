  ...
  return (
    <PageIn>
      <section className="pt-[100px] pb-16 px-6 md:px-10 max-w-7xl mx-auto">
        <p className="text-[10px] tracking-[0.32em] uppercase mb-5" style={{ color: 'rgba(225,224,204,0.3)' }}>Our Story</p>
        <h1
      ...
      <section className="pb-20 px-4 md:px-6">
        ...
        >
          <WordsPullUpMultiStyle
            segments={[
              { text: 'Visionary Web Studio is a creative agency', className: 'font-normal' },
      ...
      <section className="pb-24 px-6 md:px-10 max-w-7xl mx-auto">
        <p className="text-[10px] tracking-[0.32em] uppercase mb-12" style={{ color: 'rgba(225,224,204,0.3)' }}>What We Stand For</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {values.map((v, i) => (
            ...
            >
              <span className="font-bold text-2xl flex-shrink-0" style={{ color: 'rgba(96,165,250,0.25)', fontFamily: '"Instrument Serif", serif' }}>{v.num}</span>
              <div>
                <p className="font-bold text-base mb-2" style={{ color: '#E1E0CC' }}>{v.title}</p>
                <p className="text-sm leading-relaxed" style={{ color: 'rgba(225,224,204,0.45)' }}>{v.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <section className="py-24 px-6 text-center">
        ...
        >
          <h2
            ...
            style={{ fontSize: 'clamp(32px, 5.5vw, 80px)', color: '#E1E0CC', letterSpacing: '-0.04em' }}
          >
          ...
          >
            ...
            <span className="flex items-center justify-center rounded-full bg-black transition-transform duration-200 group-hover:scale-110" style={{ width: 30, height: 30 }}>
