...
function FeatureItem({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) {
  return (
    <motion.div
      ...
      whileHover={{ borderColor: 'rgba(96,165,250,0.2)', background: 'rgba(37,99,235,0.05)' }}
  ...
  return (
    <PageIn>
      <div style={{ background: '#03050a' }}>
        ...
        <section className="relative pt-[130px] pb-24 px-6 md:px-10 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div style={{
              ...
              width: '60%', height: '70%',
              background: 'radial-gradient(ellipse at 40% 60%, rgba(37,99,235,0.18) 0%, transparent 65%)',
              filter: 'blur(80px)',
            }} />
            <div style={{
              position: 'absolute', top: '0%', right: '-5%',
              width: '50%', height: '60%',
              background: 'radial-gradient(ellipse at 60% 40%, rgba(6,182,212,0.1) 0%, transparent 65%)',
              filter: 'blur(80px)',
            }} />
          </div>
            ...
            >
              {[
                ...
                <a
                  ...
                  style={{ background: 'rgba(37,99,235,0.12)', border: '1px solid rgba(96,165,250,0.2)', color: '#93c5fd' }}
        ...
        {/* ── WEBSITE DEVELOPMENT ── */}
        <section id="web-development" className="relative py-24 md:py-32 px-6 md:px-10 border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: 'rgba(37,99,235,0.18)', border: '1px solid rgba(96,165,250,0.25)', color: '#60a5fa' }}>
                  <Code2 size={22} />
                </div>
            ...
            {/* Types of sites strip */}
            <motion.div
              className="rounded-2xl p-7 md:p-8"
              style={{ background: 'rgba(37,99,235,0.07)', border: '1px solid rgba(96,165,250,0.15)' }}
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {['Restaurants', 'Contractors', 'Beauty Studios', 'Automotive', 'Law Firms', 'Real Estate', 'Fitness & Gyms', 'Medical & Dental', 'E-Commerce', 'Service Companies', 'Event Venues', 'Photographers'].map((tag) => (
                  <span key={tag} className="text-xs px-3 py-1.5 rounded-full" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(225,224,204,0.6)' }}>
                    {tag}
                  </span>
                ))}
              </div>
        ...
        {/* ── HOSTING & DOMAIN ── */}
        <section id="hosting" className="relative py-24 md:py-32 px-6 md:px-10 border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            <motion.div
              className="mb-14"
              initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-60px' }} transition={{ duration: 0.7 }}
        ...
        {/* ── SUPPORT ── */}
        <section id="support" className="relative py-24 md:py-32 px-6 md:px-10 border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            <motion.div
              className="mb-14"
              initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-60px' }} transition={{ duration: 0.7 }}
            ...
            <motion.div
              ...
              style={{ background: 'linear-gradient(135deg, rgba(37,99,235,0.15) 0%, rgba(6,182,212,0.06) 100%)', border: '1px solid rgba(96,165,250,0.2)' }}
              initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
            >
              <div>
        ...
        {/* CTA */}
        <section className="relative py-28 px-6 text-center border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at 50% 80%, rgba(37,99,235,0.1) 0%, transparent 60%)' }} />
          <motion.div
